...
<div class="pd_l_fr grid_19">
    <?php if (isset($key)) { ?>
        <div class="searh_res">找到了 <span class="cor_red blod"><?php echo $key; ?></span> 共计 <span
                class="cor_red blod"><?php echo count($items); ?></span>
            款供您选择
        </div>
    <?php } ?>
    <div class="pd_select">
    ...
    //                    } else {
    //                        echo '<span><a href="' . Yii::app()->createUrl('catalog/index', array_merge($_GET, array('page' => 1))) . '" class="page_p"><img alt="" src=""/>首页</a></a></span>';
    //                        echo '<span><a href="' . Yii::app()->createUrl('catalog/index', array_merge($_GET, array('page' => $pager->currentPage))) . '" class="page_p"><img alt="" src=""/>上一页</a></a></span>';
    //                    }
    ...
    <!---->
    <!--            </div>-->
    <div align="right" class="p-page"><?php
